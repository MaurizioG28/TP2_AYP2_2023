...
template <typename T>
Nodo_de<T>::Nodo_de(T dato):dato(dato),siguiente(nullptr),anterior(nullptr){}

template <typename T>
Nodo_de<T>::Nodo_de(T dato, Nodo_de<T>* anterior, Nodo_de<T>* siguiente):dato(dato),anterior(anterior),siguiente(siguiente){}
